...
def transform(df, dw=None, dw_sample=None, verbose=False):
    ...
    # classe
    df = pd.merge(df, get_class_df(), on='cod_classe', how='left')
    ...
    # grupo
    df = pd.merge(df, get_group_df(), on='cod_grupo', how='left')
    ...
    # divisao
    df = pd.merge(df, get_division_df(), on='cod_divisao', how='left')

    # cod_secao
    df = pd.merge( df, get_division_sections_df(), on='cod_divisao', how='left')

    # secao
    df = pd.merge( df, get_sections_df(), on='cod_secao', how='left')
